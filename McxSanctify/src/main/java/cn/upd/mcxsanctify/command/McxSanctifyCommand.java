...
import cn.upd.mcxsanctify.check.CheckHandLore;
import cn.upd.mcxsanctify.check.CheckLore;
import cn.upd.mcxsanctify.gui.AttributeUpgradesGui;
...
public class McxSanctifyCommand implements TabExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.RED+ "使用/mcxsanctify help查看帮助");
        return false;
    }
